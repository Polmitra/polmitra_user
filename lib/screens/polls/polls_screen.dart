...
class _PollsScreenState extends State<PollsScreen> {
  ...
  void _filterPolls() {
    if (context.read<PollBloc>().state is PollsLoaded) {
      ...
      setState(() {
        filteredPolls = text.isEmpty
            ? polls
            : polls
                .where((poll) => poll.question.toLowerCase().contains(text))
                .toList();
      });
    }
  }
            ...
            return Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  print(poll.toMap());
                  final isPollSubmitted = poll.responders
                      .any((responder) => responder.uid == userId);
                  final totalVotes = poll.responses.values
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  LinearProgressIndicator(
                                    ...
                                    minHeight: 10,
                                    value: totalVotes - voteCount > 0
                                        ? percentage / 100
                                        : 1.0,
                                    backgroundColor:
                                        ColorProvider.lightAccentOrange,
                                    valueColor:
                                        const AlwaysStoppedAnimation<Color>(
                                            ColorProvider.softOrange),
                                  ),
                                  const SizedBox(
                                      height: 10), // Spacing between bars
                                ],
                              ),
                            );
                          }),
                              ...
                              onChanged: (value) {
                                if (userId != null && netaId != null) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content:
                                          Text('User id or neta id is null'),
                                    ),
                                  );
                                }
                              },
